defmodule RocketLaunches do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(RocketLaunches.Repo, []),
    ...
    opts = [strategy: :one_for_one, name: RocketLaunches.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    RocketLaunches.Endpoint.config_change(changed, removed)
    :ok
  end
end
